// // Produce a "scanner output" version of a photo: greyscale, white-balanced,
...
//   // Find black point (2nd percentile) and white point (paper, 75th percentile)
//   const total = w * h;
//   let acc = 0;
//   let black = 0;
//   let white = 255;
...
//   // Pass 2 — stretch levels, lift midtones slightly so faint print survives
...
// // Smaller copy for sending to the AI (keeps the API payload light)
...
// Same cleanup as makeScan, but starting from a canvas rather than a File
export function enhanceCanvas(canvas, quality = 0.82) {
  ...
  if (white - black < 30) { black = 0; white = 255; }
